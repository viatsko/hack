...
public class UniformRandomNumber {
    ...
    public static int uniformRandom(int lowerBound, int upperBound) {
        ...
        do {
            ...
            // in case of we generated number which was way too large
    ...
    private static boolean uniformRandomRunner(TimedExecutor executor, int lowerBound, int upperBound) throws Exception {
        ...
        return RandomSequenceChecker.checkSequenceIsUniformlyRandom(sequence, upperBound - lowerBound + 1, 0.01);
    }
    ...
    public static void main(String[] args) {
        System.exit(GenericTest.runFromAnnotations(args, "UniformRandomNumber.java", new Object() {
