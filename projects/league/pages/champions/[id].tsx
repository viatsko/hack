...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  try {
    ...
    const championJsonData: ChampionSchema = require(`../../champions/${id}/index.tsx`)
      .default;
    ...
    const videos: YouTubeVideo[] = championJsonData.videos.slice(0, 6);

    const championRedditData: RedditItem[] = require(`../../champions/${id}/_reddit.json`)
      ?.data?.children?.map((item: any) => item.data)
      .slice(0, 12) as RedditItem[];
